...
const RangerSlider = () => {
  $(document).ready(function () {
    ...
    var code = `
      ...
      $(".range").html(
        '<span class="range-value"><sup>Rs.</sup>' +
          $("#slider-range")
            .slider("values", 0)
            .toString()
            .replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") +
          '</span><span class="range-divider"></span><span class="range-value"><sup>Rs.</sup>' +
          $("#slider-range")
            .slider("values", 1)
            .toString()
            .replace(/(\d)(?=(\d\d\d)+(?!\d))/g, "$1,") +
  ...
  return (
    <Fragment>
      <div class='RangeSlidewrapper' id='RANGE_SLIDER'>
        <div class='RangeSlidecontainer'>
          <div class='slider-wrapper'>
            ...
            <div class='marker marker-0'>
              <sup>Rs. </sup>10,000
            </div>
            <div class='marker marker-25'>
              <sup>Rs. </sup>35,000
            </div>
            <div class='marker marker-50'>
              <sup>Rs.</sup>60,000
            </div>
            <div class='marker marker-75'>
              <sup>Rs.</sup>85,000
            </div>
            <div class='marker marker-100'>
              <sup>Rs.</sup>110,000+
            </div>
          </div>
        </div>
