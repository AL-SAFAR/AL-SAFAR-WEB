...
const TravelAgentItem = ({
  ...
  return (
    <Fragment>
      <div className='card DualCard green'>
        <div className='additional'>
          <div className='user-card'>
            <div className='level center'>{level}</div>
            <div className='points center'>{Stars}</div>
            <svg
              width='110'
              height='110'
              viewBox='0 0 250 250'
...
`}
          ...
          <div className='more-info'>
            ...
            <div className='stats'>
              ...
              <div>
                <div className='title'>Current Booking</div>
